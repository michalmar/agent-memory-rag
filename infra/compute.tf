...
locals {
  ...
  backend_env = {
    ...
    SEARCH_KB                                  = local.search_assets.knowledge_base
    SEARCH_ORDERS_KNOWLEDGE_SOURCE             = local.search_assets.orders_knowledge_source
    SEARCH_POLICY_KNOWLEDGE_SOURCE             = local.search_assets.policy_knowledge_source
    SEARCH_KNOWLEDGE_API_VERSION               = local.search_assets.knowledge_api_version
    ...
    DIRECTIVE_FOUNDRY_AGENT_NAME               = var.directive_foundry_agent_name
    DIRECTIVE_AGENT_ENABLED                    = tostring(var.directive_agent_enabled)
    ...
    SUPPORT_HOSTED_AGENT_PRINCIPAL_IDS         = join(" ", sort(tolist(var.support_hosted_agent_principal_ids)))
    DIRECTIVE_HOSTED_AGENT_PRINCIPAL_IDS       = join(" ", sort(tolist(var.directive_hosted_agent_principal_ids)))
