...
locals {
  directive_ingestion_env = {
    ...
    DIRECTIVE_SOURCE_MAX_CORPUS_BYTES            = "536870912"
    ...
    DIRECTIVE_SUMMARY_MAX_INPUT_TOKENS           = "900000"
    DIRECTIVE_SUMMARY_MAX_OUTPUT_TOKENS          = "16000"
    DIRECTIVE_EMBEDDING_MAX_ITEM_TOKENS          = "8192"
    DIRECTIVE_EMBEDDING_MAX_ITEMS_PER_REQUEST    = "256"
    DIRECTIVE_EMBEDDING_MAX_AGGREGATE_TOKENS     = "240000"
    DIRECTIVE_TABLE_MAX_ROWS_PER_PART            = "25"
    DIRECTIVE_TABLE_MAX_CHARS_PER_PART           = "12000"
    DIRECTIVE_PROVIDER_MAX_ATTEMPTS              = "5"
    DIRECTIVE_PROVIDER_OPERATION_TIMEOUT_SECONDS = "180"
    DIRECTIVE_PROVIDER_RETRY_BASE_SECONDS        = "1"
    DIRECTIVE_PROVIDER_RETRY_MAX_SECONDS         = "30"
    DIRECTIVE_PROVIDER_RETRY_JITTER_RATIO        = "0.2"
    DIRECTIVE_STAGE_RETRY_BUDGET                 = "12"
    DIRECTIVE_DOCUMENT_INTELLIGENCE_CONCURRENCY  = "4"
    DIRECTIVE_EMBEDDING_CONCURRENCY              = "2"
    DIRECTIVE_SUMMARY_CONCURRENCY                = "2"
    DIRECTIVE_SEARCH_INDEXING_CONCURRENCY        = "2"
  }
}
...
resource "azurerm_role_assignment" "directive_ingestion_source_reader" {
...
resource "azurerm_container_app_job" "directive_ingestion" {
  ...
  depends_on = [
    ...
    azurerm_role_assignment.directive_ingestion_source_reader,
