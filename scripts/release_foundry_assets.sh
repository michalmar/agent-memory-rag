...
export SEARCH_KB="customer-support-kb"
export SEARCH_ORDERS_INDEX="orders"
export SEARCH_POLICY_INDEX="return-policy"
export SEARCH_ORDERS_KNOWLEDGE_SOURCE="orders-ks"
export SEARCH_POLICY_KNOWLEDGE_SOURCE="return-policy-ks"
export SEARCH_KNOWLEDGE_API_VERSION="2026-05-01-preview"
